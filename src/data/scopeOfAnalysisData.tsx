          ...
          <table className="scope-analysis__table">
            ...
            <tbody>
              <tr>
                ...
                <td>Pertains to Claims 1, 2, 3, 4, 5, 6, 7, 10, 12, 14, 15, 18, 19, 21, 22. The examiner rejects those claims under 35 U.S.C. § 102(a)(1)/(a)(2) as anticipated by <strong>Graves et al. (US 2019/0329772 A1)</strong>.</td>
              ...
              <tr>
                ...
                <td>Pertains to Claims 8, 9, 13. The examiner rejects those claims under 35 U.S.C. § 103 as unpatentable over <strong>Graves et al.</strong></td>
              ...
              <tr>
                <td><strong>Obviousness</strong></td>
                <td>Pertains to Claims 11, 16. The examiner rejects those claims under 35 U.S.C. § 103 as unpatentable over <strong>Graves et al.</strong> in view of <strong>Breuer et al. (US 2015/0012204 A1)</strong>.</td>
          ...
          <table className="scope-analysis__table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Pertains to Claim 18. The examiner rejects that claim under 35 U.S.C. § 101 as non-statutory subject matter, asserting the claim is drawn to a computer program (software per se) and indicating it should be written as nontransitory memory storing a computer program.</td>
          ...
          <table className="scope-analysis__table">
            ...
            <tbody>
              <tr>
                ...
                <td>Claims 1, 19</td>
                <td>Determines and applies a deceleration strategy when current headway falls below a target headway. The strategy is selectively optimized for comfort based on a predicted headway computed for a future time using the forward vehicle's current relative speed and acceleration. Claim 1 was selected as the representative claim for this subject matter group because it is the first strictly independent claim in the group listed in the affected-claims list for the anticipation rejection.</td>
              </tr>
              <tr>
                <td><strong>Risk-category comfort decel</strong></td>
                <td>Claim 18</td>
                <td>Determines and applies a deceleration strategy when current headway falls below a target headway. The strategy is selectively optimized for comfort based on a discrete risk category determined from the forward vehicle's current relative speed and acceleration. Claim 18 has been analyzed because it is the only strictly independent claim in this subject matter group.</td>
              </tr>
            </tbody>
          </table>
        </div>
